...
public class stringAndMethods {
	...
	public static void main(String[] args) {
		extendedChallenge.capitalize("moose");
		extendedChallenge.wheresWaldo("Where in the world is Waldo?");
		extendedChallenge.firstThingsFirst("Mr. ", "Mister ");
		extendedChallenge.reverse("Jerry");
		extendedChallenge.soLong("Extended", "Challenge");
		extendedChallenge.afterMath("This does not contain the word m4th");
		extendedChallenge.letterize("Lava!");
		System.out.println("\n*Extended Challenge Above, Assignment Itself Below*\n");
		capitalize("larry");
		wheresWaldo("Where the heck is Waldo?");
		firstThingsFirst("dog ", "cat ");
		reverse("Gary");
		soLong("Outstanding", "Work");
		afterMath("Sometimes I am good at math, but sometimes not!");
		letterize("Java!");
	}
